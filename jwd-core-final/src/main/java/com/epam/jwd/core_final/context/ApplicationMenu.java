                ...
                buf = in.nextInt();
                    switch (buf) {
                        ...
                        case 2: {
                            ...
                            do {
                                ...
                                switch (buf) {
                                    ...
                                    case 3: {
                                        System.out.println("1 - ready (true)\n" +
                                                "2 - ready (false)");
                                        do {
                                            in.nextLine();
                                            while(!in.hasNextInt()){
                        ...
                        case 4: {
                            ...
                            try{
                                if(crewServiceActs.findCrewMemberByCriteria(crewMemberCriteria).isEmpty()) throw new InvalidStateException("crew member");
                                else{
                                    handleUserInput(crewServiceActs.updateCrewMemberDetails(crewServiceActs.findCrewMemberByCriteria(crewMemberCriteria).get()));
                                }
